...
var map = {
	"./calculator_controller.js": "./app/javascript/controllers/calculator_controller.js",
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "log",
    value: function log() {
      var principal = this.targets.find("principal").value;
      var interest = this.targets.find("interest").value;
      var years = this.targets.find("years").value;
      var amount = Math.pow(principal * (1 + interest / 100), years);
      this.targets.find("amount").innerHTML = amount;
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-b653444ce7f8609af060.js.map