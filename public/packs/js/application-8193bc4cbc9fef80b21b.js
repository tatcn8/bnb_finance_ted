...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "log",
    value: function log() {
      console.log(this.targets.find("principal").value);
      console.log(this.targets.find("interest").value);
      console.log(this.targets.find("years").value);
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-8193bc4cbc9fef80b21b.js.map